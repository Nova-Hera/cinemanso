...
<div class="flex flex-col gap-6">
    <x-auth-header :title="__('Logar na sua conta')" :description="__('Insira seus e-mail e senha abaixo para logar')" />
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <div class="flex items-center justify-end">
            <flux:button variant="primary" type="submit" class="w-full">{{ __('Logar') }}</flux:button>
        </div>
    </form>
