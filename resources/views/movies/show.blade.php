            ...
            <div class="flex-1 min-w-0 flex flex-col gap-6">
                ...
                <div style="display:flex; align-items:center; gap:1rem; flex-wrap:wrap;">
                    ...
                    <div x-data="{ showCreateForm: false, showEditForm: false }">
                        ...
                        @if ($userReview === null)
                        <flux:button @click="showCreateForm = true"
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="rounded-lg border border-zinc-200 dark:border-zinc-700
                                bg-white dark:bg-zinc-900 p-4 border-l-4" style="border-left-color:rgb(0,123,24)">
                        ...
                        <p class="text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed whitespace-pre-line">{{ trim($review->content) }}</p>
                    </div>
                    @endforeach
                </div>
                @endif
